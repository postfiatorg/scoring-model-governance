...
Vendored adaptation for the governance service: byte-identical to
scoring_service/services/response_parser.py except that the foundation
import of ValidatorIdentityMap is inlined as its underlying type alias.
The provenance copy lives in _vendor_source/ pinned by content hash.
"""
